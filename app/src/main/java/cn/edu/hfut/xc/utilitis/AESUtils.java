...
/**
 * Created by MarksLin on 2015/4/20 0020.
 */
public class AESUtils {
    ...
    public static String encrypt(String seed, String clearText) {
        ...
        byte[] result = null;
        try {
            byte[] rawkey = getRawKey(seed.getBytes("UTF-8"));//已修改
    ...
    public static String decrypt(String seed, String encrypted) {
        ...
        byte[] rawKey;
        try {
            rawKey = getRawKey(seed.getBytes("UTF-8"));//已修改
    ...
    private static byte[] getRawKey(byte[] seed) throws Exception {
        ...
        SecureRandom sr = SecureRandom.getInstance("SHA1PRNG", "Crypto");//Android4.2.2需要加上
        sr.setSeed(seed);
        kgen.init(128, sr);
